        ...
        if ($this->getsVars ==""):
            if ($this->PagesFound>1):
                if ($this->currentPage!=1):
                    $result .= "<a href='?page=1' title='".$this->msg_initialPage."'><img border=\"0\" src=\"images/icons/resultset_first.png\"></a>&nbsp;";
                endif;
                if ($this->currentPage>1):             $result .= "<a href='?page=".($previous)."'><img border=\"0\" src=\"images/icons/resultset_previous.png\"></a>&nbsp;&nbsp;";     endif;
                if (($this->currentPage < $this->PagesFound) && ($this->PagesFound >= 1)):    $result .= " <a href='?page=".($next)."'><img border=\"0\" src=\"images/icons/resultset_next.png\"></a>";
				endif;
                if (($this->PagesFound>1)&&($this->currentPage!=$this->PagesFound)):
                    $result .=  "&nbsp;<a href='?page=".$this->PagesFound."'><img border=\"0\" src=\"images/icons/resultset_last.png\"></a>";
                endif;
            endif;
        else:
            if ($this->currentPage!=1):
    ...
    function getCurrentPages()
    {
        ...
        for ($a = $begin; $a <= $end ; $a++):
            if ($a!=$this->currentPage):
                if ($this->getsVars ==""):
                    $result .= " <a href='?page=$a'>$a</a>&nbsp;";
                else:
                    $result .= " <a href='?page=$a&".$this->getsVars."'>$a</a>&nbsp;";
                endif;
            else:
