	...
	<div class="page-content">
		<div class="container">
				...
				<div class="col-md-12">
                    ...
                    <form action="" method="post">
                	    ...
                	    <td width="20%">
                                    ...
                                    <select class='form-control'  name='subject'  style="margin-left:-40%; width:137% " onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?program='+escape(this.value);" >
                    ...
                    <td width="25%">
                                   <select class='form-control' style="margin-left:-73%;  width:72% "  onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?nation='+escape(this.value);"     >
                                       <option value=''>Filter by Nationalities</option>
                                        <option value='All Nations'>All Nationalities</option>
                    ...
                    <td>&nbsp;</td>
                      <td width="20%">
                        ...
                        <select class='form-control'  name='term'  style="margin-left:-126%;  width:66% " onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?term='+escape(this.value);" >
                     ...
                     <td>&nbsp;</td>
                      ...
                      <td>&nbsp;</td>
                      <td width="25%">
                           <select class='form-control'  name='term' required="" style="margin-left:-1001%;  width:478% " onchange="document.location.href='<?php echo $_SERVER['PHP_SELF'] ?>?gender='+escape(this.value);" >
                                         <option value=''>Filter by gender</option>
                                        <option value='All gender'>All gender</option>
                                        <option value='1'<?php if($_SESSION[gender]=='M'){echo 'selected="selected"'; }?>>Male</option>
                                        <option value='2'<?php if($_SESSION[gender]=='F'){echo 'selected="selected"'; }?>>Female</option>
                  ...
                  <form action="students.php" method="post" >
                      ...
                      <td>&nbsp;</td>
                       <td width="25%">
                           <select class='form-control'  name='term' required="" style="margin-left:-56%;  width:478% "  >
                                         <option value=''>search by</option>
                                        
                                        <option value='1'<?php if($_SESSION[status]=='1'){echo 'selected="selected"'; }?>>Surname</option>
                                        <option value='2'<?php if($_SESSION[status]=='2'){echo 'selected="selected"'; }?>>First Name</option>
                                        <option value='3'<?php if($_SESSION[status]=='3'){echo 'selected="selected"'; }?>>Index No</option>
                                        <option value='4'<?php if($_SESSION[status]=='4'){echo 'selected="selected"'; }?>>Program</option>
                                        <option value='5'<?php if($_SESSION[status]=='5'){echo 'selected="selected"'; }?>>Level</option>
			...
			<div class="portlet-body">
                                          ...
                                          print_r(  $query="SELECT  * FROM tpoly_students   where 1 $program_  $level_ ");
                        ...
                        <table  id="data-table-command" class="table table-striped table-vmiddle"  >
                            <thead>
                                <tr>
                                     ...
                                     <th data-column-id="Course" data-type=" " data-toggle="tooltip">PIC</th>
                                     <th >INDEX</th>
                                      <th>NAME</th> 
                                      <th>PROGRAM</th>
                                ...
                                <?php
                                   ...
                                   $count=0;
                                    while($rtmt=$stmt->FetchRow()){
                                                         ...
                                                         elseif($rtmt[STATUS]==2){
                                                             $status="Deffered";
                                                         }
                                                         elseif($rtmt[STATUS]==3){
                                                             $status="Deceased";
                                                         }
                                                         elseif($rtmt[STATUS]==4){
                                                             $status="Suspension";
                                                         }
                                                         else{
                                                             $status="Alummi";
                                    ...
                                    <tr>
                                     ...
                                     <td><img <?php   ?> style="width:80px;height: 70px"   src="<?php echo file_exists("photos/students/$rtmt[INDEXNO].JPG") ? "photos/students/$rtmt[INDEXNO].JPG":"photos/students/user.jpg";?>" alt=" Picture of Student Here"    /></td>
                                     <td style="text-align:left;text-transform: capitalize"><?php echo $rtmt[INDEXNO] ?></td>
                                    <td ><?php  echo $rtmt[NAME] ; ?></td>
                                    ...
                                    <td style="text-align: center"><?php echo $help->age($rtmt[DATEOFBIRTH], "mysql") ?></td>
                                    <td style="text-align: center"><?php echo $rtmt["TELEPHONENO"] ?></td>
                                    <td style="text-align: center"><?php echo $rtmt["COUNTRY"] ?></td>
                                    <td style="text-align:  "><?php echo strtoupper( $rtmt["GRADUATING_GROUP"]) ?></td>
                                    <td style="text-align:  "><?php echo $status?></td>
