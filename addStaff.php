...
if (isset($_GET[no]) != "") {
    $_SESSION[no] = $_GET[no]; // he is an old student for update
} else {
...
if (isset($_GET['upload'])) {
    ...
    if ($error > 0) {
        ...
        $destination = "photos/workers/$_SESSION[indexno].jpg";
                ...
                <div class="col-md-12">
                    ...
                    <div class="note note-success note-bordered">
                        ...
                        <div style="margin-top:-2.2%;float:right">
                            <form action="addStaff.php" method="post">
                                ...
                                <button type="submit" style="margin-left: -145px;"name="sync" class="btn btn-primary waves-effect">Import staff from csv<i class="fa fa-file-excel-o"></i></button>
                            </form>
                    ...
                    <div class="portlet light">
                        ...
                        <div class="portlet-body">
                            <div align="center">
                                <?php
                                if ($_GET[success] || $_GET[no] || $_GET["error"]) {
                                    $staff = $_SESSION[no] or $_GET[success];
                                    $query = $sql->Prepare("SELECT * FROM tpoly_workers WHERE ids='$staff'  ");
                                        ...
                                        <form action="addStudent.php?upload=1" method="POST" enctype="multipart/form-data">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <img <?php $person = $rows->EMP_NUMBER;
echo $help->picture("photos/workers/$person.jpg", 199) ?>  src="<?php echo file_exists("photos/workers/$person.jpg") ? "photos/workers/$person.jpg" : "photos/workers/user.jpg"; ?>" alt=" Picture of Staff Here" data-toggle="modal" href="#modalWider"/>
                                                </div>
                                    ...
                                    <div class="row" style="margin-top:5%" >
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Staff No  </label>
                                                <div class="col-md-9">
                                                    <input type="text" required="" readonly="readonly" class="form-control" name="indexno" value="<?php echo $rows->EMP_NUMBER ?>" >
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" required=""   class="form-control" name="fname" value="<?php echo $rows->NAME ?>" >
                                    ...
                                    echo "selected='selected'";
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                     <span id="dob">
                                                         <input type="text" required="" name="dob"  class="form-control" placeholder="dd/mm/yyyy" value="<?php echo date("d/m/Y",$rows->DOB) ?>">
